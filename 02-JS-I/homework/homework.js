...
function elevar(num, exponent) {
  ...
  // Tu código:
  var ElevExp = Math.pow(num,exponent);
  return ElevExp;
...
function redondearNumero(num) {
  ...
  // Tu código:
  var RedondeoCerca = Math.round(num);
...
function redondearHaciaArriba(num) {
  ...
  // Tu código:
  var RedondeoMayor=Math.ceil(num);
